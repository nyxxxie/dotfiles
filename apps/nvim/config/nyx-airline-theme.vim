...
let g:airline#themes#nyx#palette.normal_modified = s:modified
...
let g:airline#themes#nyx#palette.insert_modified = s:modified
...
let g:airline#themes#nyx#palette.visual_modified = s:modified
...
let g:airline#themes#nyx#palette.replace_modified = s:modified
...
let g:airline#themes#nyx#palette.inactive = airline#themes#generate_color_map(s:IN1, s:IN2, s:IN3)
let g:airline#themes#nyx#palette.inactive_modified = s:modified
